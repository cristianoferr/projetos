...
define("MODULO_ENTITY_MANAGER", "entityManager");
define("MODULO_DIAGRAMAS", "diagramas");
define("MODULO_TAREFAS", "tarefa");
define("MODULO_ADMIN", "admin");
define("MODULO_MAIN_PAGE", "main_page");
define("MODULO_SITE_MANAGER", "siteManager");
define("MODULO_KNOWLEDGE", "knowledge");
define("MODULO_ABTEST", "abtesting");
define("MODULO_VIRTUAL_ENTITY", "virtual_entity");
define("MODULO_VIRTUALIZER", "virtualizer");
...
function defineArquivos() {
    ...
    adicionaModuloCarga(MODULO_ENTITY_MANAGER);
    ...
    adicionaModuloCarga(MODULO_VIRTUAL_ENTITY);
