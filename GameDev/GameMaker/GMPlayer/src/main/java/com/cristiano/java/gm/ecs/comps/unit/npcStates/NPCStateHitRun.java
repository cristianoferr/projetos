...
public class NPCStateHitRun extends AbstractNPCStateComponent{

	public NPCStateHitRun(){
		super(GameComps.COMP_NPC_STATE_HITRUN);
	}
	...
	public IGameComponent clonaComponent() {
		AbstractNPCStateComponent state = new NPCStateHitRun();
