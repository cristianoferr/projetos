...
import cyclone.rigidBody.forceGenerator.ForceGenerator;
...
public class ForceRegistry {
     ...
     */
         ...
         */
        Vector<ForceRegistration> registrations=new Vector();
    ...
    public void add(RigidBody particle, ForceGenerator fg){
         ...
         * no effect.
         */
    public void remove(RigidBody particle, ParticleForceGenerator fg){
