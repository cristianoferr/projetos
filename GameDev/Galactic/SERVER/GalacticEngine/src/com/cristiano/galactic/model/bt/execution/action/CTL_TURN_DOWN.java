...
/** ExecutionAction class created from MMPM action CTL_TURN_DOWN. */
public class CTL_TURN_DOWN extends
	...
	/**
	 * Constructor. Constructs an instance of CTL_TURN_DOWN that is able to run
	 * a galactic.model.bt.model.action.CTL_TURN_DOWN.
	 * 
	 * @param intensity
	 ...
	 */
	public CTL_TURN_DOWN(
			com.cristiano.galactic.model.bt.model.action.CTL_TURN_DOWN modelTask,
	...
	protected void internalSpawn() {
		...
		*/
		//System.out.println("TURN_DOWN: "+getIntensity()+" "+this.getContext().getVariable("TargetAlignVert"));
		ItemsController.getItemsController().activateControl(currentEntityID, ControlEnum.CTL_TURN_DOWN,getIntensity(),0.5);
		//ItemsController.getItemsController().activateControl(currentEntityID, ControlManager.CTL_TURN_DOWN,(Double)this.getContext().getVariable("TargetAlignVert"));
	}
