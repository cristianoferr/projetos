...
/** ExecutionAction class created from MMPM action CTL_MOVE_DOWN. */
public class CTL_MOVE_DOWN extends
	...
	/**
	 * Constructor. Constructs an instance of CTL_MOVE_DOWN that is able to run
	 * a galactic.model.bt.model.action.CTL_MOVE_DOWN.
	 * 
	 * @param intensity
	 ...
	 */
	public CTL_MOVE_DOWN(
			com.cristiano.galactic.model.bt.model.action.CTL_MOVE_DOWN modelTask,
