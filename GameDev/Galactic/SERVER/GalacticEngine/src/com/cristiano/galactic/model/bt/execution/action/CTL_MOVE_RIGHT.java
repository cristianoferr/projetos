...
/** ExecutionAction class created from MMPM action CTL_MOVE_RIGHT. */
public class CTL_MOVE_RIGHT extends
	...
	/**
	 * Constructor. Constructs an instance of CTL_MOVE_RIGHT that is able to run
	 * a galactic.model.bt.model.action.CTL_MOVE_RIGHT.
	 * 
	 * @param intensity
	 ...
	 */
	public CTL_MOVE_RIGHT(
			com.cristiano.galactic.model.bt.model.action.CTL_MOVE_RIGHT modelTask,
