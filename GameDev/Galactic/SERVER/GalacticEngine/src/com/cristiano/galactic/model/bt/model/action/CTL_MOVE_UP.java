...
/** ModelAction class created from MMPM action CTL_MOVE_UP. */
public class CTL_MOVE_UP extends jbt.model.task.leaf.action.ModelAction {
	/**
	...
	/**
	 * Constructor. Constructs an instance of CTL_MOVE_UP.
	 * 
	 * @param intensity
	 ...
	 */
	public CTL_MOVE_UP(jbt.model.core.ModelTask guard,
	...
	/**
	 * Returns a galactic.model.bt.execution.action.CTL_MOVE_UP task that is
	 * able to run this task.
	 */
	public jbt.execution.core.ExecutionTask createExecutor(
			jbt.execution.core.BTExecutor executor,
			jbt.execution.core.ExecutionTask parent) {
		return new com.cristiano.galactic.model.bt.execution.action.CTL_MOVE_UP(this,
