...
/** ExecutionCondition class created from MMPM condition SelfROCHorizIsLow. */
public class SelfROCHorizIsLow extends
		jbt.execution.task.leaf.condition.ExecutionCondition {

	/**
	 * Constructor. Constructs an instance of SelfROCHorizIsLow that is able to
	 * run a galactic.model.bt.model.condition.SelfROCHorizIsLow.
	 */
	public SelfROCHorizIsLow(
			com.cristiano.galactic.model.bt.model.condition.SelfROCHorizIsLow modelTask,
	...
	protected jbt.execution.core.ExecutionTask.Status internalTick() {
		...
		if (QueryCentral.checkQuery(currentEntityID, QueryCentral.QUERY_SELFLOWROTATIONHORIZ)>0){
