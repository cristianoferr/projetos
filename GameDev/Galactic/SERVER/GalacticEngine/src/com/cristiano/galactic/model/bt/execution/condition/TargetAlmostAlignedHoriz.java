 ...
 * TargetAlmostAlignedHoriz.
 */
public class TargetAlmostAlignedHoriz extends
		jbt.execution.task.leaf.condition.ExecutionCondition {

	/**
	 * Constructor. Constructs an instance of TargetAlmostAlignedHoriz that is
	 * able to run a galactic.model.bt.model.condition.TargetAlmostAlignedHoriz.
	 */
	public TargetAlmostAlignedHoriz(
			com.cristiano.galactic.model.bt.model.condition.TargetAlmostAlignedHoriz modelTask,
...
//		System.out.println(this.getClass().getCanonicalName() + " spawned");
	...
	protected jbt.execution.core.ExecutionTask.Status internalTick() {
		...
		if (QueryCentral.checkQuery(currentEntityID, QueryCentral.QUERY_TARGETALMOSTALIGNEDHORIZ)>0){
			//System.out.println("AlmostAlignHoriz");
