...
/** ExecutionAction class created from MMPM action CTL_TURN_RIGHT. */
public class CTL_TURN_RIGHT extends
	...
	/**
	 * Constructor. Constructs an instance of CTL_TURN_RIGHT that is able to run
	 * a galactic.model.bt.model.action.CTL_TURN_RIGHT.
	 * 
	 * @param intensity
	 ...
	 */
	public CTL_TURN_RIGHT(
			com.cristiano.galactic.model.bt.model.action.CTL_TURN_RIGHT modelTask,
	...
	protected void internalSpawn() {
		...
		*/
		ItemsController.getItemsController().activateControl(currentEntityID, ControlEnum.CTL_TURN_RIGHT,getIntensity(),0.5);
	}
