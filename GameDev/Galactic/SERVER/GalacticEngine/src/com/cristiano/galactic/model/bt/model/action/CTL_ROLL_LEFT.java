...
/** ModelAction class created from MMPM action CTL_ROLL_LEFT. */
public class CTL_ROLL_LEFT extends jbt.model.task.leaf.action.ModelAction {
	/**
	...
	/**
	 * Constructor. Constructs an instance of CTL_ROLL_LEFT.
	 * 
	 * @param intensity
	 ...
	 */
	public CTL_ROLL_LEFT(jbt.model.core.ModelTask guard,
	...
	/**
	 * Returns a galactic.model.bt.execution.action.CTL_ROLL_LEFT task that is
	 * able to run this task.
	 */
	public jbt.execution.core.ExecutionTask createExecutor(
			jbt.execution.core.BTExecutor executor,
			jbt.execution.core.ExecutionTask parent) {
		return new com.cristiano.galactic.model.bt.execution.action.CTL_ROLL_LEFT(this,
