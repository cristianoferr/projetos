...
/** ExecutionCondition class created from MMPM condition SelfRotatingRight. */
public class SelfRotatingRight extends
		jbt.execution.task.leaf.condition.ExecutionCondition {

	/**
	 * Constructor. Constructs an instance of SelfRotatingRight that is able to
	 * run a galactic.model.bt.model.condition.SelfRotatingRight.
	 */
	public SelfRotatingRight(
			com.cristiano.galactic.model.bt.model.condition.SelfRotatingRight modelTask,
	...
	protected jbt.execution.core.ExecutionTask.Status internalTick() {
		...
		if (QueryCentral.checkQuery(currentEntityID, QueryCentral.QUERY_SELFROTATINGRIGHT)>0){
