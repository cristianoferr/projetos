...
/** ExecutionAction class created from MMPM action CTL_MOVE_UP. */
public class CTL_MOVE_UP extends jbt.execution.task.leaf.action.ExecutionAction {
	/**
	...
	/**
	 * Constructor. Constructs an instance of CTL_MOVE_UP that is able to run a
	 * galactic.model.bt.model.action.CTL_MOVE_UP.
	 * 
	 * @param intensity
	 ...
	 */
	public CTL_MOVE_UP(com.cristiano.galactic.model.bt.model.action.CTL_MOVE_UP modelTask,
