...
/** ExecutionAction class created from MMPM action CTL_ROLL_LEFT. */
public class CTL_ROLL_LEFT extends
	...
	/**
	 * Constructor. Constructs an instance of CTL_ROLL_LEFT that is able to run
	 * a galactic.model.bt.model.action.CTL_ROLL_LEFT.
	 * 
	 * @param intensity
	 ...
	 */
	public CTL_ROLL_LEFT(
			com.cristiano.galactic.model.bt.model.action.CTL_ROLL_LEFT modelTask,
