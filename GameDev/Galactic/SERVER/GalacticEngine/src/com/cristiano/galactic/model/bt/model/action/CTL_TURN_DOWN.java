...
/** ModelAction class created from MMPM action CTL_TURN_DOWN. */
public class CTL_TURN_DOWN extends jbt.model.task.leaf.action.ModelAction {
	/**
	...
	/**
	 * Constructor. Constructs an instance of CTL_TURN_DOWN.
	 * 
	 * @param intensity
	 ...
	 */
	public CTL_TURN_DOWN(jbt.model.core.ModelTask guard,
	...
	/**
	 * Returns a galactic.model.bt.execution.action.CTL_TURN_DOWN task that is
	 * able to run this task.
	 */
	public jbt.execution.core.ExecutionTask createExecutor(
			jbt.execution.core.BTExecutor executor,
			jbt.execution.core.ExecutionTask parent) {
		return new com.cristiano.galactic.model.bt.execution.action.CTL_TURN_DOWN(this,
