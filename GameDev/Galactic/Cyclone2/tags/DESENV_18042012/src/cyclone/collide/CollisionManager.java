...
import cyclone.collide.fine.CollisionDetectorAbstract;
...
import cyclone.entities.GeomPoly.InternalPoint;
...
public class CollisionManager  extends ObjetoBasico{
...
public void checkCollisionBetweenBodies(RigidBody b1,RigidBody b2){
	...
	//System.out.println("Checando entre "+b1+" e "+b2);
	 ...
	 boolean checkBothBullets=((b1.isDestroyOnContact()) && (b2.isDestroyOnContact()));
	 if ((b2.getOwner()!=b1) && (b1.getOwner()!=b2) && (!checkBothBullets)){
