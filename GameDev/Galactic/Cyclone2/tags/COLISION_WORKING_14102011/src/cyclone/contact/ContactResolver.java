...
public class ContactResolver {
     ...
     */
          ...
          //      System.out.println("Size: "+contacts.size());
             ...
             */
            void adjustVelocities(Vector<Contact> c,
                double duration){
                ...
                while (velocityIterationsUsed < c.size()*velocityIterations)
                {
                    ...
                    for (int i = 0; i < numContacts; i++)
                    {
                        ...
                        for (int b = 0; b < 2; b++) if (c.get(i).body[b]!=null)
                        {
                            ...
                            for (int d = 0; d < 2; d++)
                            {
                                if (c.get(i).body[b] == c.get(index).body[d])
                                {
                                    deltaVel = velocityChange[d].getAddVector(rotationChange[d].getVectorProduct(
                                            c.get(i).relativeContactPosition[b]));

                                    // The sign of the change is negative if we're dealing
                                    // with the second body in a contact.
                                    c.get(i).contactVelocity.addVector(
                                    		c.get(i).contactToWorld.transformTranspose(deltaVel).getMultiVector(b==1?-1:1));
                        ...
                        for (int b = 0; b < 2; b++) if (c.get(i).body[b]!=null)
                        {
                            ...
                            for (int d = 0; d < 2; d++)
                            {
                                if (c.get(i).body[b] == c.get(index).body[d])
                                {
                                    ...
                                    c.get(i).penetration +=
                                        deltaPosition.scalarProduct(c.get(i).contactNormal)
                                        * (b==1?1:-1);
                                }
                            }
                        }
