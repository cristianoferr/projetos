    ...
    Vector3 particleMovement[];
        ...
        void calculateDesiredDeltaVelocity(double duration){
            ...
            if (body[0].getAwake())
            {
             ...
             //	double d=body[0].getLastFrameAcceleration().componentProduct(contactNormal.getMultiVector(duration)).magnitude();
            	...
            	if (body[1].getAwake())
            {
            	/*	Vector3 v=new Vector3(body[1].getLastFrameAcceleration());
               	...
               	velocityFromAcc-=v.magnitude();*/
            		velocityFromAcc-=body[1].getLastFrameAcceleration().componentProduct(contactNormal.getMultiVector(duration)).magnitude();
            }
