...
public class CollisionDetector {
    ...
    public static int sphereAndHalfSpace(
        ...
        Vector<Contact> cont = data.contacts;
    ...
    public static int boxAndHalfSpace(
        ...
        static int boxAndBox(
            ...
            if (!tryAxis(one, two, two.getAxis(0), toCentre, 0, pen, best)) return 0;
            if (!tryAxis(one, two, two.getAxis(1), toCentre, 1, pen, best)) return 0;
            if (!tryAxis(one, two, two.getAxis(2), toCentre, 2, pen, best)) return 0;
...
if (!tryAxis(one, two, one.getAxis(0).getVectorProduct(two.getAxis(0)), toCentre, 6, pen, best)) return 0;
if (!tryAxis(one, two, one.getAxis(0).getVectorProduct(two.getAxis(1)), toCentre, 7, pen, best)) return 0;
if (!tryAxis(one, two, one.getAxis(0).getVectorProduct(two.getAxis(2)), toCentre, 8, pen, best)) return 0;
if (!tryAxis(one, two, one.getAxis(1).getVectorProduct(two.getAxis(0)), toCentre, 9, pen, best)) return 0;
if (!tryAxis(one, two, one.getAxis(1).getVectorProduct(two.getAxis(1)), toCentre, 10, pen, best)) return 0;
if (!tryAxis(one, two, one.getAxis(1).getVectorProduct(two.getAxis(2)), toCentre, 11, pen, best)) return 0;
if (!tryAxis(one, two, one.getAxis(2).getVectorProduct(two.getAxis(0)), toCentre, 12, pen, best)) return 0;
if (!tryAxis(one, two, one.getAxis(2).getVectorProduct(two.getAxis(1)), toCentre, 13, pen, best)) return 0;
if (!tryAxis(one, two, one.getAxis(2).getVectorProduct(two.getAxis(2)), toCentre, 14, pen, best)) return 0;
            ...
            else if (best < 6)
            {
                ...
                // centres).
                fillPointFaceBoxBox(two, one, toCentre.getMultiVector(-1.0f), data, best-3, pen);
                data.addContacts(1);
                return 1;
            }
            else
            {
                ...
                ptOnOneEdge = one.transform.getMulti(ptOnOneEdge);
                ptOnTwoEdge = two.transform.getMulti(ptOnTwoEdge);
