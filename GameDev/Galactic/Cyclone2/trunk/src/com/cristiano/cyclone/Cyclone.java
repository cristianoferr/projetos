...
import com.cristiano.cyclone.collide.CollisionManager;
import com.cristiano.cyclone.collide.CollisionSolverEnum;
import com.cristiano.cyclone.collide.fine.CollisionData;
import com.cristiano.cyclone.contact.ContactResolver;
...
import com.cristiano.cyclone.forceGenerator.SimpleGravity;
import com.cristiano.cyclone.forceGenerator.SpaceGravity;
import com.cristiano.cyclone.forceRegistry.ForceRegistry;
...
public static void logDebug(String msg){
	logger.debug("(cyclone.logDebug):"+msg);
}
public static void logFatal(String msg){
	logger.fatal("(cyclone.logFatal):"+msg);
}
...
//		System.out.println("t:"+ShotType.ARTILLERY.ordinal());
	...
	private void applyGravityEmitters(RigidBody receiver,float duration){
		...
		if ((!CycloneConfig.APPLY_GRAVITY_ON_EMITTERS) && (receiver.isGravityEmitter())){//Não aplico gravidade nos corpos que emitem gravidade...
			return;
		}
		try {
...
//	    System.out.println("initLoop");
       for (int i=0;i<getItems().size();i++){
    	   ...
    	   fixRotation(geom,i);
    	   /*if (getItem(i).getName().equals("Nave Jogador")){
    		   System.out.println("pos: "+getItem(i).getPosition()+" vel: "+getItem(i).getVelocity());
    	   }*/
    	    
    	   //TODO: ativar emissao de gravidade
